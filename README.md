...
First, let's **[download the latest tarball](https://gitlab.com/librewolf-community/browser/source/-/jobs/artifacts/main/raw/librewolf-96.0-2.source.tar.gz?job=build-job)**. This tarball is the latest produced by the [CI](https://gitlab.com/librewolf-community/browser/source/-/jobs).

To download the latest from a script, use wget/curl like this:
```
wget -O librewolf-96.0-2.source.tar.gz https://gitlab.com/librewolf-community/browser/source/-/jobs/artifacts/main/raw/librewolf-96.0-2.source.tar.gz?job=build-job
curl -L -o librewolf-96.0-2.source.tar.gz https://gitlab.com/librewolf-community/browser/source/-/jobs/artifacts/main/raw/librewolf-96.0-2.source.tar.gz?job=build-job
```
...
mkdir build
cd build
tar xf ../librewolf-96.0-2.source.tar.gz
```
